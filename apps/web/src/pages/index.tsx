  ...
  return (
    <div className="max-w-7xl w-full mx-auto space-y-80">
      <SectionInView className="flex bg-green-500 w-full justify-between gap-10 mt-80">
        <img alt="" src={fandom} className="w-1/2" />
        <div className="w-1/3">
      ...
      <SectionInView
        animateClass="animate-fade-right"
        className="flex w-full bg-pink-100 justify-between gap-10"
      >
        <img alt="" src={fandom} className="w-1/2" />
        <div className="w-1/3">
          <h1 className="font-bold text-5xl">
      ...
      <SectionInView
        animateClass="animate-fade-right"
        className="flex bg-red-500 w-full justify-between gap-10"
      >
        <img alt="" src={fandom} className="w-1/2" />
        <div className="w-1/3">
          <h1 className="font-bold text-5xl">
